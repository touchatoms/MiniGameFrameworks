...
namespace MotionFramework.Scene
{
	...
	public sealed class SceneManager : ModuleSingleton<SceneManager>, IModule
	{
		...
		public void ChangeMainScene(string location, bool activeOnLoad, System.Action<SceneHandle> callback)
		{
		...
		/// <param name="callback">场景加载完毕的回调</param>
		public void LoadAdditionScene(string location, bool activeOnLoad, System.Action<SceneHandle> finishCallback = null,
			System.Action<int> progressCallback = null)
		{
