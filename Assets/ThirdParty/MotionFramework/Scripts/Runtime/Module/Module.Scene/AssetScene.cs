...
namespace MotionFramework.Scene
{
	internal class AssetScene
	{
		...
		private System.Action<SceneHandle> _finishCallback;
		...
		public void Load(bool isAdditive, bool activeOnLoad, System.Action<SceneHandle> finishCallback, System.Action<int> progressCallbcak)
		{
			if (_handle != null)
				return;
